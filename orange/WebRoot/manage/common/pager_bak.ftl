	...
	<div style="text-align: right; border: 0;padding: 4px 12px;" class="pageDiv">
		<@pg.pager url="${pager.pagerUrl}" items=pager.total
			...
			<#if pager.pagerSize gt 1>
					...
					<!--<a href="#" class="pageLink" onclick="selectList(this)" method="selectList">首页</a>-->
			<#else>
			...
			<@pg.prev>
				...
				<!--<a href="#" class="pageLink" onclick="selectList(this)" method="selectList">上一页</a>-->
			</@pg.prev>
			<@pg.pages>
            <#if currentPageNumber==pageNumber>
                ...
                <#else >
                    ...
                    <!--<a href="#" class="pageLink" onclick="selectList(this)" method="selectList">${pageNumber}</a>-->
            </#if>
			</@pg.pages>
			<@pg.next>
				<a href="${pageUrl}" class="pageLink">下一页</a>
				<!--<a href="#" class="pageLink" onclick="selectList(this)" method="selectList">下一页</a>-->
			</@pg.next>
			<@pg.last>
			<#if pager.pagerSize gt 1>
					<a href="${pageUrl}" class="pageLink">尾页</a>
					<!--<a href="#" class="pageLink" onclick="selectList(this)" method="selectList">尾页</a>-->
			<#else>
