    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${basepath}cas/user/home">后台管理系统</a>
            </div>
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="${basepath}/cas/user/show?account=${currentUser().username}" target="_blank"><i class="fa fa-user fa-fw"></i> 用户信息</a>
                        </li>
                        <li><a href="${basepath}/cas/user/toChangePwd"><i class="fa fa-gear fa-fw"></i> 修改密码</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="${basepath}/cas/user/logout"><i class="fa fa-sign-out fa-fw"></i> 注销</a>
                        </li>
                    </ul>
                </li>
            </ul>
                ...
                <div class="col-lg-12">
                    <div class="navbar navbar-default">
                        <ol class="breadcrumb bootstrap-admin-breadcrumb">
                            <li>
                                <a href="${basepath}/cas/user/home">首页</a>
                            </li>
