...
<![endif]-->
<script src="${staticpath}/global/plugins/jquery-migrate.min.js" type="text/javascript"></script>
<!-- IMPORTANT! Load jquery-ui.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
<script src="${staticpath}/global/plugins/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
<script src="${staticpath}/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${staticpath}/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
...
<script src="${staticpath}/global/plugins/jquery.cokie.min.js" type="text/javascript"></script>
<script src="${staticpath}/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
...
<script src="${staticpath}/global/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="${staticpath}/global/plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
<script src="${staticpath}/global/plugins/bootstrap-daterangepicker/daterangepicker.js" type="text/javascript"></script>
...
<script src="${staticpath}/global/scripts/metronic.js" type="text/javascript"></script>
<script src="${staticpath}/local/layout/scripts/layout.js" type="text/javascript"></script>
<script src="${staticpath}/local/layout/scripts/quick-sidebar.js" type="text/javascript"></script>
<script src="${staticpath}/local/layout/scripts/demo.js" type="text/javascript"></script>
