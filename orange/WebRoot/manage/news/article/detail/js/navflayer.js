...
(function(window, factory) {
    ...
    var $ = window.$,
        ...
        navShadow = $("div#navShadow").css({position:"fixed","z-index":"9998"}),smsNum,smsNumContainer,callback=window.navFlayer||(window.navFlayer={});
    //在这里定义函数
    var showNav = function(){
        ...
        headerPosition = header.css("position"), headerPosition !== "fixed" && header.css({"position":"fixed","width":"100%","top":"0px","z-index":"9999"});
